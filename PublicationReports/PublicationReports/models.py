...
class Publication(models.Model):
    ...
    pages = models.CharField(max_length=20, null=True, default=None, blank=True, verbose_name='Страницы')
    citation = models.IntegerField(null=True, default=None, blank=True, verbose_name='Цитирования')
    author = models.ManyToManyField(Author, verbose_name='Автор')
    journal = models.ForeignKey(Journal, on_delete=models.CASCADE, null=True, default=None, blank=True, verbose_name='Журнал')
    book = models.ForeignKey(Book, on_delete=models.CASCADE, null=True, default=None, blank=True, verbose_name='Книга')
    conference = models.ForeignKey(Conference, on_delete=models.CASCADE, null=True, default=None, blank=True, verbose_name='Конференция')
